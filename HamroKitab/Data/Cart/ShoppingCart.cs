...
namespace HamroKitab.Data.Cart
{
    public class ShoppingCart
    {
        public HamroDbContext _context { get; set; }
        public string ShoppingCartId { get; set; }
        public List<ShoppingCartItem> ShoppingCartItems { get; set; }
        public ShoppingCart(HamroDbContext context)
        {
            _context = context;
        }
        public static ShoppingCart GetShoppingCart(IServiceProvider services)
        {
            ...
            var context = services.GetService<HamroDbContext>();
        ...
        public void AddItemToCart(Books Book)
        {
        ...
        public void RemoveItemFromCart(Books Book)
        {
            var shoppingCartItem = _context.ShoppingCartItems.FirstOrDefault(n => n.Book.Id == Book.Id && n.ShoppingCartId == ShoppingCartId);
